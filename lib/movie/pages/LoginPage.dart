...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController userController = new TextEditingController(text: userInfo.userId);
    TextEditingController pwdController = new TextEditingController(text: "123456");
          ...
          child: Column(
            children: <Widget>[
              Form(
                ...
                child: Column(
                  children: <Widget>[
                    Center(child: Image.asset("lib/assets/images/icon-logo.png",width: ThemeSize.movieWidth/2,height: ThemeSize.movieWidth/2,)),
