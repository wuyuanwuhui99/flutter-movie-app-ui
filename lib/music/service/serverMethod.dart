...
Future <ResponseModel<List>>getMusicListByClassifyIdService(int classifyId,int pageNum,int pageSize,int isRedis) async {
  try {
...
///@description: 获取分类音乐列表
/// @date: 2023-05-25 22:45
Future <ResponseModel<List>>getSingerListService(String category,int pageNum,int pageSize) async {
  try {
...
///@description: 获取分类音乐列表
/// @date: 2023-05-25 22:45
Future <ResponseModel<List>>getCircleListByTypeService(String type,int pageNum,int pageSize) async {
  try {
...
Future <ResponseModel<List>>getMySingerService(int pageNum,int pageSize) async {
  try {
...
///@description: 获取我关注的歌手
/// @date: 2023-07-09 11:29
Future <ResponseModel<List>>getMusicRecordService(int pageNum,int pageSize) async {
  try {
...
Future <ResponseModel<int>>insertMusicRecordService(MusicModel musicModel) async {
  try {
...
Future <ResponseModel<int>>insertMusicFavoriteService(MusicModel musicModel) async {
  try {
...
///@description: 删除收藏
/// @date: 2024-01-05 23:44
Future <ResponseModel<List>>queryMusicFavoriteService(int pageNum,int pageSize) async {
  try {
...
Future<ResponseModel<List>> searchMusicService(String keyword,int pageNum,int pageSize) async {
  try {
